...
namespace tlotd.Content.MainMenu
{
    public class TlotdMainMenu : ModMenu
    {
        public class Cinder
        {
            public int Time;
        ...
        public override string DisplayName => "TLOTD";

        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("tlotd/Content/MainMenu/Logo");
        public override Asset<Texture2D> SunTexture => ModContent.Request<Texture2D>("tlotd/Content/MainMenu/BlankPixel");
        public override Asset<Texture2D> MoonTexture => ModContent.Request<Texture2D>("tlotd/Content/MainMenu/BlankPixel");

        Mod musicMod = tlotd.Instance;
        public override int Music => MusicLoader.GetMusicSlot(musicMod, "Content/Sounds/Music/TlotdTitle");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("tlotd/Content/MainMenu/MenuBackground").Value;
            ...
            // Draw cinders.
            Texture2D cinderTexture = ModContent.Request<Texture2D>("tlotd/Content/MainMenu/Cinder").Value;
            for (int i = 0; i < Cinders.Count; i++)
            {
