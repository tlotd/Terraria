using System;
using tlotd.Content.Buffs.Mounts;
...
{
    public class DeLorean : ModMount
    {
        public override void SetStaticDefaults()
        {
            MountData.spawnDust = 173;
            MountData.spawnDustNoGravity = true;
            MountData.buff = ModContent.BuffType<DeLoreanBuff>();
            ...
            {
                MountData.frontTextureExtra = ModContent.Request<Texture2D>("tlotd/Content/Items/Mounts/DeLoreanExtra");
